      ...
      <div id="movie-container">
        ...
        <div id="movie-info">
            <div>
                ...
                <h3>{{movie.year}}</h3>
                <h3>{{movie.genre}}</h3>
                <h3><span id="movie-rating" :style="{'background-color': getRatingColor() }" >{{movie.rating}}</span></h3>
            ...
            <div id="options">
                <button class="edit" @click="showModel = true">Edit</button>
...
import ratingMixins from "../mixins/getRatingColor"
...
export default {
	...
	methods:{
		updateMovie(){
			this.$store.dispatch("updateMovies", this.movie);
		},
